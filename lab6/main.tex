...
\include{content/ЦельРаботы}
\include{content/ПостановкаЗадач}
\include{content/ТеоретическаяИнформация}
\include{content/Результаты}
\include{content/Выводы}
\include{content/КонтрольРезультатов}
\include{content/ПриложенныеФайлы}
