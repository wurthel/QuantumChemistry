...
Энергия возбуждения перехода 1, полученного в расчете методом HF/6-31G-CIS, оказалась по величине больше, чем в расчете методом TDDFT/B3LYP/STO-3G, но в целом близки.
