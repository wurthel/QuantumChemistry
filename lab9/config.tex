...
\newcommand{\num}{}
\newcommand{\docname}{Отчет по лабораторной работе №9, вариант 16}
\newcommand{\subject}{Определение энергий и интенсивностей электронных переходов молекул хиназолина методом HF/6-31G-CIS}
