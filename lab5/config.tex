...
\newcommand{\num}{}
\newcommand{\docname}{Отчет по лабораторной работе №5, вариант 16}
\newcommand{\subject}{Определение структуры комплексов пропанола с молекулой воды и энергии образующейся водородной связи}
