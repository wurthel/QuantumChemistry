...
\newcommand{\num}{}
\newcommand{\docname}{Отчет по лабораторной работе №7, вариант 16}
\newcommand{\subject}{Поиск седловой точки молекулы трифторметанола в барьере поворота вокруг C-O-связи}
